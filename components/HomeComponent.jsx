    ...
    <section className="min-h-screen flex items-center">
      <div className="flex w-full justify-between items-center p-16">
        <div className="max-w-[744px] ml-8 -mt-10">
          <h1
            className={`tracking-widest text-black font-bold text-4xl bg-clip-text p-6`}
          >
            TaxWizard
          </h1>
          <h1
            className={`text-2xl bg-gradient-to-r from-[#2a393f] via-[#1d0d30] to-[#532369] bg-clip-text text-transparent p-6`}
          >
            The place to calculate and save your tax informations!
          </h1>
